...
describe("Calculator: Compound interest", () => {
  ...
  test("should return 732.81 given 100, 10 percent, 20 years", () => {
    ...
    expect(Calculator.calculateCompoundInterest(result)).toBe(732.81)
  });
  test("should return 181.94 given 100, 6 percent, 10 years", () => {
    ...
    expect(Calculator.calculateCompoundInterest(result)).toBe(181.94)
  });
  ...
  test("should return 149,058.55 given 100000, 5 percent, 8 years", () => {
    ...
    expect(Calculator.calculateCompoundInterest(result)).toBe(149058.55)
  });
  ...
  test("should return 0.00 given 0, 10 percent, 1 year", () => {
    ...
    expect(Calculator.calculateCompoundInterest(result)).toBe(0.00)
  });
  ...
  test("should return 100.00 given 100, 0 percent, 10 years", () => {
    ...
    expect(Calculator.calculateCompoundInterest(result)).toBe(100.00)
  });
});
